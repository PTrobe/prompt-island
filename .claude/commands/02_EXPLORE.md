...
- Analyze and understand the existing Python/React codebase thoroughly.
- Determine exactly how this feature integrates, including dependencies, structure, edge cases (e.g., LLM context window limits, DB locks), and constraints.
